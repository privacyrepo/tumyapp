...
class BirthdayNotificationComponent extends StatelessWidget {
  final NotificationModel element;

  BirthdayNotificationComponent({required this.element});
    ...
    return Row(
      ...
      children: [
        ...
        Container(
          ...
          child: Image.asset('images/tumy/icons/ic_Cake.png',
